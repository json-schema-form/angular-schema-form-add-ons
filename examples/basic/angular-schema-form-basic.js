angular.module("schemaForm").run(["$templateCache", function($templateCache) {$templateCache.put("directives/decorators/bootstrap/basic/angular-schema-form-basic.html","<div ng-class=\"{\'has-error\': hasError()}\">\n    <label ng-show=\"showTitle()\">{{form.title}}</label>\n\n    <div basic>\n        <input name=\"input_field\" ng-model=\"$$value$$\"/>\n        <button type=\"button\" ng-click=\"makeCamelCase()\">camelCase it</button>\n    </div>\n    <span class=\"help-block\">{{ (hasError() && errorMessage(schemaError())) || form.description}}</span>\n</div>\n");}]);
